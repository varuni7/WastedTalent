            ...
            child: Padding(
              ...
              child: Row(children: [
                IconButton(onPressed: () async {
                  var myuid= await getUserInfo(_auth.currentUser?.uid);
                  sendNotification(widget.uid, myuid[0]['name'], data['title'], 1);
                ...
                IconButton(onPressed: () async {
                  var myuid= await getUserInfo(_auth.currentUser?.uid);
                  sendNotification(widget.uid, myuid[0]['name'], messageController.text, 0);
